...
A user issues two queries as seen in fig. \ref{fig:directcache}, \ref{fig:indirectcache}, and \ref{fig:advancedroutequery} . We can then argue, using these figures and the map in fig. \ref{fig:map10} about all the optimizations we plan to use. (same queries in all figures, and they corrospond to map)
