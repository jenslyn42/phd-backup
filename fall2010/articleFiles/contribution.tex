...
\begin{figure}
  \center
	\includegraphics[width=0.4\textwidth]{figures/map10n.pdf}
	\caption{Small map}
  \label{fig:map10}
\end{figure}
...
\begin{figure}
  \center
	\includegraphics[width=0.4\textwidth]{figures/nodeType.pdf}
	\caption{Node types}
  \label{fig:nodetypes}
\end{figure}
...
\begin{figure}
  \center
	\includegraphics[width=0.55\textwidth]{figures/cacheSimple.pdf}
	\caption{Direct cache access}
  \label{fig:map10}
\end{figure}

\begin{figure}
  \center
	\includegraphics[width=0.55\textwidth]{figures/cacheTwoLayer.pdf}
	\caption{Indirect cache access}
  \label{fig:map10}
\end{figure}
