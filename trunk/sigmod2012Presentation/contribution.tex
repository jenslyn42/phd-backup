...
\begin{tabular}{lc}
    ...
    \end{tabular}
&
\multirow{3}{*}{\includegraphics[width=0.68\columnwidth]{images/mappartition}} \\
& \\
	...
	\\
&
% \multicolumn{2}{c}{\includegraphics[width=0.75\columnwidth]{images/rxmap}}
...
\end{columns}
  ...
  \begin{picture}(0.0,0.0) 
     \put(160,30){  \includegraphics[width=0.5\textwidth]{images/scenario} }
  \end{picture}
...
\end{tabular}
  ...
  \begin{picture}(0.0,0.0) 
     \put(90,5){  \includegraphics[width=0.7\textwidth]{images/rxmap} }
  \end{picture}
