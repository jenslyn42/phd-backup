...
set output "split_runtime_bei_server.eps"
...
plot "v_split_SPC_bei_server.test" using 10:1 title 'SPC' with linespoints pt 8 lw 2,\
"v_split_SPCSTAR_bei_server.test" using 10:1 title 'SPC^*' with linespoints pt 14 lw 2
