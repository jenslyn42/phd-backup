...
set output "split_diffruntime_bei_server.eps"
...
plot "v_split_SPC_NONE_bei_server_diff.test" using 11:(100*($16-$2)/$16) title 'SPC' with linespoints pt 8 lw 2,\
"v_split_SPCSTAR_NONE_bei_server_diff.test" using 11:(100*($16-$2)/$16)  title 'SPC^*' with linespoints pt 14 lw 2
