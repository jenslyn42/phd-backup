...
Line 4 of algorithm \ref{alg:greedy} starts looping to fill up the cache, terminating when either the cache is full (i.e. $| \Phi | \leq  \mathcal{B}$) or when \textbf{H} becomes empty (i.e. no more candidates to add to the 
