...
We have previously introduced the notion of utility and shown how we can use the frequency of \spaths (Tab. \ref{tab:freq}) on a map to calculate the utilty of an individual \spathns. We will here make it clear how we extract the frequency information, the statistics, of \spaths on a map.

\subsubsection{Statistics extraction}

%howto extract statistics



\subsubsection{Generating SP Candidates}

% Generating SP Candidates for \salgo
