...
set output "split_nodes_aal_server.eps"
...
plot "v_split_SPC_aal_server.test" using 10:5 title 'SPC' with linespoints pt 8 lw 2,\
"v_split_SPCSTAR_aal_server.test" using 10:5 title 'SPC^*' with linespoints pt 14 lw 2
