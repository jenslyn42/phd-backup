...
set output "split_hitratio_aal_server.eps"
...
plot  "v_split_SPC_aal_server.test" using 10:(($2/($2+$3))*100) title 'SPC' with linespoints pt 8 lw 2,\
"v_split_SPCSTAR_aal_server.test" using 10:(($2/($2+$3))*100) title 'SPC^*' with linespoints pt 4 lw 2
