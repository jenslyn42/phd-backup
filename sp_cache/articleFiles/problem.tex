...
If a path $P_{S,T}: v_S,v_{S+1},\ldots,v_T$ is a \spath, then $\forall$ $(v_K,v_L) | S \leq (K \wedge L) \geq T$ there is a  \spath $P_{K,L}$ with start-/end-node in $v_K,v_L$
\end{lemma}
