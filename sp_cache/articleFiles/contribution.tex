...
$Q_{1,6}:$ 	& $\{SP_{1,3},SP_{1,4},SP_{1,5},SP_{1,6},SP_{3,4},SP_{3,5},$\\
	 	& $SP_{3,6},SP_{4,5},SP_{4,6},SP_{5,6}\}$ \\\
$Q_{2,6}:$ 	& $\{SP_{2,3},SP_{2,4},SP_{2,5},SP_{2,6},SP_{3,4},SP_{3,5},$ \\
		& $SP_{3,6},SP_{4,5},SP_{4,6},SP_{5,6}\}$ \\
$Q_{1,4}:$ 	& $\{SP_{1,3},SP_{1,4},SP_{3,4}\}$ \\
$Q_{4,7}:$ 	& $\{SP_{4,5},SP_{4,7},SP_{5,7}\}$ \\
$Q_{1,5}:$ 	& $\{SP_{1,3},SP_{1,4},SP_{1,5},SP_{3,4},SP_{3,5},SP_{4,5}\}$ \\
$Q_{3,6}:$ 	& $\{SP_{3,4},SP_{3,5},SP_{3,6},SP_{4,5},SP_{4,6},SP_{5,6}\}$ \\
\end{tabular}
